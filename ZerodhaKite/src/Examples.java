...
public class Examples {
    ...
    public void tickerUsage(KiteConnect kiteConnect, final ArrayList<Long> tokens) throws IOException, WebSocketException, KiteException {
        ...
        final KiteTicker tickerProvider = new KiteTicker("wss://ws.zerodha.com/?api_key=kitefront&user_id=DA6170&public_token=vVi0VQw01mM3an9TDolPLL7TtNVeD7vS&uid=1553116891262&user-agent=kite3-web&version=2.1.0");
        ...
        tickerProvider.setOnTickerArrivalListener(new OnTicks() {
            ...
            public void onTicks(ArrayList<Tick> ticks) {
                ...
                for(int i = 0 ; i < ticks.size(); i++){
                	Tick tk = ticks.get(i);
                	System.out.println(tk.getInstrumentToken()+"  ltp: "+tk.getLastTradedPrice());
                }
            }
        });
