...
public class Routes {
    ...
    */
    ...
    private static String _rootUrl = "https://kite.zerodha.com/oms";
    ...
    public String get(String key){
    	if(key.equalsIgnoreCase("market.instruments") || key.equalsIgnoreCase("market.instruments.all")){
    		 return "https://api.kite.trade" + routes.get(key);
    	}
