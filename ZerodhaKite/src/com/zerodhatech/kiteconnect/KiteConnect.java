...
public class KiteConnect {
     ...
     */
    public KiteConnect(String authorization){
    ...
    public Profile getProfile() throws IOException, KiteException, JSONException {
        ...
        JSONObject response = new KiteRequestHandler(proxy).getRequest(url, authorization);
    ...
    public Order placeOrder(OrderParams orderParams, String variety) throws KiteException, JSONException, IOException {
        ...
        JSONObject jsonObject = new KiteRequestHandler(proxy).postRequest(url, params, authorization);
    ...
    public Order modifyOrder(String orderId, OrderParams orderParams, String variety) throws KiteException, JSONException, IOException {
        ...
        JSONObject jsonObject = new KiteRequestHandler(proxy).putRequest(url, params, authorization);
        Order order =  new Order();
        order.orderId = jsonObject.getJSONObject("data").getString("order_id");
        return order;
    }
    ...
    public Order cancelOrder(String orderId, String variety) throws KiteException, JSONException, IOException {
        ...
        JSONObject jsonObject = new KiteRequestHandler(proxy).deleteRequest(url, params, authorization);
        Order order =  new Order();
        order.orderId = jsonObject.getJSONObject("data").getString("order_id");
        return order;
    }
    ...
    public List<Trade> getTrades() throws KiteException, JSONException, IOException {
        JSONObject response = new KiteRequestHandler(proxy).getRequest(routes.get("trades"), authorization);
    ...
    public List<Trade> getOrderTrades(String orderId) throws KiteException, JSONException, IOException {
        JSONObject response = new KiteRequestHandler(proxy).getRequest(routes.get("orders.trades").replace(":order_id", orderId), authorization);
        return Arrays.asList(gson.fromJson(String.valueOf(response.get("data")), Trade[].class));
    }
    ...
    public List<Holding> getHoldings() throws KiteException, JSONException, IOException {
        JSONObject response = new KiteRequestHandler(proxy).getRequest(routes.get("portfolio.holdings"), authorization);
        return Arrays.asList(gson.fromJson(String.valueOf(response.get("data")), Holding[].class));
    }

    public JSONObject getHoldingsData() throws KiteException, JSONException, IOException {
        JSONObject response = new KiteRequestHandler(proxy).getRequest(routes.get("portfolio.holdings"), authorization);
        return response;
    }
    
    public List<Holding> formatHoldings(JSONObject response) throws KiteException, JSONException, IOException {
        return Arrays.asList(gson.fromJson(String.valueOf(response.get("data")), Holding[].class));
    }
    ...
    public Map<String, List<Position>> getPositions() throws KiteException, JSONException, IOException {
        ...
        JSONObject response = new KiteRequestHandler(proxy).getRequest(routes.get("portfolio.positions"), authorization);
    ...
    public JSONObject convertPosition(String tradingSymbol, String exchange, String transactionType, String positionType, String oldProduct, String newProduct, int quantity) throws KiteException, JSONException, IOException {
        ...
        return kiteRequestHandler.putRequest(routes.get("portfolio.positions.modify"), params, authorization);
    }
    ...
    public List<Instrument> getInstruments() throws KiteException, IOException, JSONException {
        KiteRequestHandler kiteRequestHandler = new KiteRequestHandler(proxy);
        return readCSV(kiteRequestHandler.getCSVRequest(routes.get("market.instruments.all"), authorization));
    }

    public String getInstrumentsData() throws KiteException, IOException, JSONException {
    	KiteRequestHandler kiteRequestHandler = new KiteRequestHandler(proxy);
    	return kiteRequestHandler.getCSVRequest(routes.get("market.instruments.all"), authorization);
    }
    
    public List<Instrument> formatInstruments(String input) throws KiteException, IOException, JSONException {    	
    ...
    public List<Instrument> getInstruments(String exchange) throws KiteException, JSONException, IOException {
        KiteRequestHandler kiteRequestHandler = new KiteRequestHandler(proxy);
        return readCSV(kiteRequestHandler.getCSVRequest(routes.get("market.instruments").replace(":exchange", exchange), authorization));
    }
    ...
    public Map<String, Quote> getQuote(String [] instruments) throws KiteException, JSONException, IOException {
        KiteRequestHandler kiteRequestHandler = new KiteRequestHandler(proxy);
        JSONObject jsonObject = kiteRequestHandler.getRequest(routes.get("market.quote"), "i", instruments, authorization);
    ...
    public Map<String, OHLCQuote> getOHLC(String [] instruments) throws KiteException, IOException, JSONException {
        JSONObject resp = new KiteRequestHandler(proxy).getRequest(routes.get("quote.ohlc"), "i", instruments, authorization);
    ...
    public Map<String, LTPQuote> getLTP(String[] instruments) throws KiteException, IOException, JSONException {
        JSONObject response = new KiteRequestHandler(proxy).getRequest(routes.get("quote.ltp"), "i", instruments, authorization);
    ...
    public Map<String, TriggerRange> getTriggerRange(String[] instruments, String transactionType) throws KiteException, JSONException, IOException {
        ...
        JSONObject response = new KiteRequestHandler(proxy).getRequest(url, "i", instruments, authorization);
    ...
    public HistoricalData getHistoricalData(Date from, Date to, String token, String interval, boolean continuous) throws KiteException, IOException, JSONException {
        ...
        historicalData.parseResponse(new KiteRequestHandler(proxy).getRequest(url, params, authorization));
    ...
    public List<MFInstrument> getMFInstruments() throws KiteException, IOException, JSONException {
        KiteRequestHandler kiteRequestHandler = new KiteRequestHandler(proxy);
        return readMfCSV(kiteRequestHandler.getCSVRequest(routes.get("mutualfunds.instruments"), authorization));
    }
    ...
    public MFOrder placeMFOrder(String tradingsymbol, String transactionType, double amount, double quantity, String tag) throws KiteException, IOException, JSONException {
        ...
        JSONObject response = new KiteRequestHandler(proxy).postRequest(routes.get("mutualfunds.orders.place"), params, authorization);
    ...
    public boolean cancelMFOrder(String orderId) throws KiteException, IOException, JSONException {
        KiteRequestHandler kiteRequestHandler = new KiteRequestHandler(proxy);
        kiteRequestHandler.deleteRequest(routes.get("mutualfunds.cancel_order").replace(":order_id", orderId), new HashMap<String, Object>(), authorization);
        return true;
    }
    ...
    public List<MFOrder> getMFOrders() throws KiteException, IOException, JSONException {
        JSONObject response = new KiteRequestHandler(proxy).getRequest(routes.get("mutualfunds.orders"), authorization);
    ...
    public MFOrder getMFOrder(String orderId) throws KiteException, IOException, JSONException {
        JSONObject response = new KiteRequestHandler(proxy).getRequest(routes.get("mutualfunds.order").replace(":order_id", orderId), authorization);
    ...
    public MFSIP placeMFSIP(String tradingsymbol, String frequency, int installmentDay, int instalments, int initialAmount, double amount) throws KiteException, IOException, JSONException {
        ...
        JSONObject response = new KiteRequestHandler(proxy).postRequest(routes.get("mutualfunds.sips.place"),params, authorization);
    ...
    public boolean modifyMFSIP(String frequency, int day, int instalments, double amount, String status, String sipId) throws KiteException, IOException, JSONException {
        ...
        new KiteRequestHandler(proxy).putRequest(routes.get("mutualfunds.sips.modify").replace(":sip_id", sipId), params, authorization);
        return true;
    }
    ...
    public boolean cancelMFSIP(String sipId) throws KiteException, IOException, JSONException {
        new KiteRequestHandler(proxy).deleteRequest(routes.get("mutualfunds.sip").replace(":sip_id", sipId), new HashMap<String, Object>(), authorization);
        return true;
    }
    ...
    public List<MFSIP> getMFSIPs() throws KiteException, IOException, JSONException {
        JSONObject response = new KiteRequestHandler(proxy).getRequest(routes.get("mutualfunds.sips"), authorization);
    ...
    public MFSIP getMFSIP(String sipId) throws KiteException, IOException, JSONException {
        JSONObject response = new KiteRequestHandler(proxy).getRequest(routes.get("mutualfunds.sip").replace(":sip_id", sipId), authorization);
    ...
    public List<MFHolding> getMFHoldings() throws KiteException, IOException, JSONException {
        JSONObject response = new KiteRequestHandler(proxy).getRequest(routes.get("mutualfunds.holdings"), authorization);
