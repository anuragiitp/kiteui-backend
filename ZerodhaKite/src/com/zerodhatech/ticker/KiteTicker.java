...
public class KiteTicker {
    ...
    public KiteTicker(String wsuri) {
   ...
   public void setOnErrorListener(OnError listener){
        ...
        try {
            ...
            if(type.equals("order")) {
                if(orderUpdateListener != null) {
                    orderUpdateListener.onOrderUpdate(getOrderNew(data));
                }
            }
    ...
    public Order getOrderNew(JSONObject data) {
        ...
        return gson.fromJson(String.valueOf(data), Order.class);
    }
